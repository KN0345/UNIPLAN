  ...
  return (
    <>
      <section className="creditStrip">
        <button type="button" className="creditMain creditProgressButton" onClick={openTotal} title="查看計入畢業進度的課程">
          <strong>畢業進度 {summary.total}/{rules.totalCredits}</strong><CreditStackBar completed={summary.completed} planned={summary.planned} max={rules.totalCredits} /><span>{summary.percent}%</span>
        </button>
