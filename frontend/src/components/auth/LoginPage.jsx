...
function PasswordInput({ field, placeholder, autoComplete, value, visible, onChange, onToggle }) {
  return (
      ...
      <form className={`authCard authV4Card ${isRegister ? 'registerInfoMode' : ''} ${isRegisterPassword ? 'registerPasswordMode' : ''} ${isForgot ? 'forgotMode' : ''} ${isGoogleSetup ? 'googleSetupMode' : ''}`} onSubmit={submitWithLoading}>
        ...
        {isLogin && (
          <>
            ...
            <label className="authField">
              <span>密碼</span>
              <PasswordInput field="password" placeholder="輸入密碼" autoComplete="current-password" value={loginForm.password} visible={Boolean(visiblePasswords.password)} onChange={updateField} onToggle={togglePasswordVisible} />
            </label>
          </>
        )}
        ...
        {isRegisterPassword && (
          <>
            ...
            <label className="authField">
              <span>密碼</span>
              <PasswordInput field="password" placeholder="至少 6 碼" autoComplete="new-password" value={loginForm.password} visible={Boolean(visiblePasswords.password)} onChange={updateField} onToggle={togglePasswordVisible} />
            </label>
            <label className="authField">
              <span>確認密碼</span>
              <PasswordInput field="confirmPassword" placeholder="再次輸入密碼" autoComplete="new-password" value={loginForm.confirmPassword} visible={Boolean(visiblePasswords.confirmPassword)} onChange={updateField} onToggle={togglePasswordVisible} />
            </label>
          </>
        )}
        ...
        {isForgot && resetRequested && (
          <>
            ...
            <label className="authField">
              <span>新密碼</span>
              <PasswordInput field="newPassword" placeholder="至少 6 碼" autoComplete="new-password" value={loginForm.newPassword} visible={Boolean(visiblePasswords.newPassword)} onChange={updateField} onToggle={togglePasswordVisible} />
            </label>
            <label className="authField">
              <span>確認新密碼</span>
              <PasswordInput field="confirmPassword" placeholder="再次輸入新密碼" autoComplete="new-password" value={loginForm.confirmPassword} visible={Boolean(visiblePasswords.confirmPassword)} onChange={updateField} onToggle={togglePasswordVisible} />
            </label>
          </>
        )}
