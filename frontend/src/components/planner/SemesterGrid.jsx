...
function cleanupDragPreview() {
  ...
  document.removeEventListener('dragover', window.__uniplanDragMove)
  document.removeEventListener('drag', window.__uniplanDragMove)
...
function makeTransparentDragImage(event) {
  try {
    ...
    // Some browsers can ignore custom drag images; the floating clone still works.
  }
}
...
function makeCourseDragPreview(event, course) {
  ...
  source.addEventListener('dragend', cleanupDragPreview, { once: true })
}
