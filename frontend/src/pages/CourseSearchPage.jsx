...
export default function CourseSearchPage(props) {
  ...
  useEffect(() => {
    ...
    const maxRender = hasActiveSearch ? 96 : 80
  ...
  return (
    <section className="searchPage singleColumn">
              <div className="searchColumn">
                ...
                {renderedCourses.length < sortedFilteredCourses.length ? <button type="button" className="searchButton" onClick={() => setRenderLimit((value) => Math.min(sortedFilteredCourses.length, value + 80))}>顯示更多課程</button> : null}
