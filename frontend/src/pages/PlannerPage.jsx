              ...
              <div className="plannerLayout">
                ...
                <aside className="plannerTools">
                  ...
                  <section className="toolCard quickActions"><h3>操作</h3>
                    <div className="autoPlanInline">
                      <div className="autoPlanInlineHead"><strong>一鍵排入</strong><span>{selectedAutoPlanSemesters().length} 學期</span></div>
                      <div className="autoPlanRange compactAutoPlanRange">
                      ...
                      <button className="autoPlanButton" disabled={!candidates.length} onClick={runAutoPlanRange}>一鍵排入</button>
                    </div>
