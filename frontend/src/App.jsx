  ...
  return (
    <div className="appShell">
      ...
      <main className="main">
        ...
        {infoOpen && <div className="infoOverlay" onMouseDown={(e) => { if (e.target.className === 'infoOverlay') setInfoOpen(false) }}><div className="infoModalShell"><button className="closeInfo modalCloseFixed" onClick={() => setInfoOpen(false)}>關閉</button><div className="infoDrawerPanel"><CourseInfo course={selectedCourse} reviews={reviews} tagVotes={tagVotes} onTagVote={toggleTeacherTag} userId={userKey(user)} onAddReview={handleAddReview} onUpdateReview={updateLocalReview} onDeleteReview={deleteLocalReview} /></div></div></div>}
      </main>
