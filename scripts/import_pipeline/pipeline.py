...
def main():
    ...
    normalized = {'term': args.semester, 'source_type': 'html_archive', 'parser': 'parser_115', 'parser_version': '1.0.1', 'generated_at': generated, 'source_files': len(files), 'raw_rows': len(rows), 'courses': clean_rows}
